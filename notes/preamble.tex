...
\usecounter{testembedcounter}
\renewcommand{\thetestembedcounter}{\arabic{testembedcounter}}

\newenvironment{testembed}[1]{%
\refstepcounter{testembedcounter}%
\label{#1}%
\begin{verbatim}}%
{\end{verbatim}}
\newcommand{\getembed}[1]{%
  \begin{tcolorbox}%
    \getstored{#1}%
    \end{tcolorbox}%
  }
...
\definecolor{cat-latte-maroon}{HTML}{EBA0AC}
...
\newtcbtheorem[no counter]{attention}{Attention}%
