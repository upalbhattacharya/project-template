...
\definechangesauthor[name='TODO', color=cat-latte-yellow]{TODO}
\definechangesauthor[name='REVIEW', color=cat-latte-purple]{REVIEW}
\definechangesauthor[name='FIX', color=cat-latte-orange]{FIX}
\definechangesauthor[name='BUG, color=cat-latte-red]{BUG}
